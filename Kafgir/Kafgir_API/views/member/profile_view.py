...
class ProfileView(ViewSet):
    ...
    @swagger_auto_schema(responses=dto_to_swagger_json_output(ProfileOutput), tags=['member','profile'])
    ...
    @swagger_auto_schema(request_body=profile_password_change_serializer, responses=dto_to_swagger_json_output(None), tags=['member','profile'])
    ...
    @swagger_auto_schema(request_body=profile_serializer, responses=dto_to_swagger_json_output(ProfileOutput), tags=['member','profile'])
    ...
    @swagger_auto_schema(request_body=profile_set_picture_serializer, responses=dto_to_swagger_json_output(None), tags=['member','profile'])
    ...
    @swagger_auto_schema(responses=dto_to_swagger_json_output(None), tags=['member','profile'])
