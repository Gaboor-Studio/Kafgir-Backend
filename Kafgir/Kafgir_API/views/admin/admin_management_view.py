...
class AdminManagementView(ViewSet):
    ...
    @swagger_auto_schema(responses=dto_to_swagger_json_output(AdminOutput), tags=['admin', 'admin-management'])
    ...
    @swagger_auto_schema(responses=dto_to_swagger_json_output(AdminBriefOutput, many=True), tags=['admin', 'admin-management'])
    ...
    @swagger_auto_schema(request_body=AdminRegisterSerializer ,responses=dto_to_swagger_json_output(AdminOutput), tags=['admin', 'admin-management'])
    ...
    @swagger_auto_schema(request_body=AdminProfileUpdateSerializer ,responses=dto_to_swagger_json_output(AdminOutput), tags=['admin', 'admin-management'])
    ...
    @swagger_auto_schema(request_body=AdminResetPasswordSerializer ,responses=dto_to_swagger_json_output(AdminOutput), tags=['admin', 'admin-management'])
    ...
    @swagger_auto_schema(responses=dto_to_swagger_json_output(None), tags=['admin', 'admin-management'])
